...
class Model:
    def __init__(self):
        ...
        pre_trained_model = os.path.join(self.classifier_config["model_path_1"], 'model.pt')
        ...
        print(f"The model1 is read at {datetime.datetime.now()}")
    ...
    def predict(self, text):
        ...
        """entity_pair_tensor = torch.LongTensor(encoded_text)
        entity_pair_tensor = entity_pair_tensor.unsqueeze(0)
        entity_pair_tensor = entity_pair_tensor.to(self.device)"""
